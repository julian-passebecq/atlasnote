...
The superseded report is preserved in [docs/history](docs/history/v22-before-finalization-20260919/WORKSPACE_READY_FOR_GITHUB.md). The finalization manifest is [FINAL_QA_MANIFEST.json](docs/evidence/v22/FINAL_QA_MANIFEST.json).
