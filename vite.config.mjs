...
export default defineConfig({
 ...
 build:{outDir:'dist',emptyOutDir:true,target:'es2022',sourcemap:false,
  rollupOptions:{preserveEntrySignatures:'strict',input:{main:fileURLToPath(new URL('./index.html',import.meta.url)),snapshot:fileURLToPath(new URL('./src/storage/workspace-snapshot.ts',import.meta.url))},
   output:{entryFileNames:chunk=>chunk.name==='snapshot'?'app/storage/workspace-snapshot.js':'assets/[name]-[hash].js'}}},
