...
export function validateSavedStates(value,sessions){
 ...
 function session(s){
  ...
  keys(s,['panes','activePane','ratio','screen','leftOpen','rightOpen','focus','theme','libraryMode','showFlags','expanded','fontSize','categoryFilter','compactTop','collapsedPane','collapsedGroups','pdfTreeExpanded']);
  sessions.push(s);
 }
 function entry(e){
