...
export function validatePersonal(p){
 ...
 const anchor=a=>{if(a===undefined)return;obj(a,'anchor');if(a.blockId!==undefined)id(a.blockId,'anchor block');if(a.offset!==undefined)num(a.offset,'anchor offset');if(a.unit!==undefined)str(a.unit,'source unit',256);if(a.viewportOffset!==undefined)num(a.viewportOffset,'anchor viewport offset',-1000000,1000000);if(a.atStart!==undefined)bool(a.atStart,'anchor start');if(a.pdfPage!==undefined)int(a.pdfPage,'physical PDF page',1,1000000);if(a.pdfRevision!==undefined)str(a.pdfRevision,'PDF revision',256);if(a.pdfOffset!==undefined)num(a.pdfOffset,'PDF page offset',-10,10);};
