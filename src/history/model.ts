...
export type HistoryData={archives?:import('../durability/model.js').ArchiveDescriptor[];schemaVersion:1;meta:HistoryMeta;heads:ResourceHead[];revisions:ResourceRevision[];reviews:AgentReviewRecord[]};
