...
/** Toggle only the overlay surface; reading sessions are never snapshots or copies. */
export function toggleDashboard(s:Session){if(s.surface==='dashboard')closeSurface(s);else openDashboard(s);}
