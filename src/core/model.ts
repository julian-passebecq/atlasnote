...
export type Personal={dashboardItems?:import('../content-hub/model.js').DashboardItem[];qcmAttempts?:import('../content-hub/model.js').QcmAttempt[];qcmResponses?:import('../content-hub/model.js').QcmResponse[];documentVisits?:{pageId:string;firstOpenedAt:number;lastOpenedAt:number}[];readLater?:import('./reading-types.js').ReadingItem[];savedStates?:import('./saved-states-types.js').SavedStates;schemaVersion:2|3;activeWorkspaceSlot?:WorkspaceNumber;workspaceSlots?:Partial<Record<2|3|4|5,Session>>;notes:Record<string,Remark>;ratings:Record<string,'gray'|'red'|'orange'|'green'>;bookmarks:Bookmark[];session:Session};
