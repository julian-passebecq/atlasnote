...
export type CollectionItem = {node:TreeNode;project:Project;page?:Page;document?:DocumentEntry;type:'folder'|'note'|'pdf'|'reference';language:string;domains:string[];technologies:string[];summary:string};
