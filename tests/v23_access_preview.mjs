...
import {PROVIDER_CASES} from '../tools/v23-release-contract.mjs';import {sourceIdentity} from '../tools/check-v23-build.mjs';
const out=process.env.ATLAS_EVIDENCE??'docs/evidence/v23/access-preview';fs.mkdirSync(out,{recursive:true});
const target=process.env.ATLAS_V23_PREVIEW_URL??'https://deploy-preview-18--atlasnotej.netlify.app';
